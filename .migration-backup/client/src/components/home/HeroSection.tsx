      ...
      <div className="container mx-auto px-4 md:px-8 z-10 relative">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              Muhammad <span className="text-primary">Ibrahim</span>
            </motion.h1>
            ...
            >
              ...
              technologies. Specializing in creating responsive, accessible, and
            ...
            >
              ...
              <motion.a
                href="https://www.linkedin.com/in/muhammad-ibrahim-a69825245"
                target="_blank"
                rel="noopener noreferrer"
                className="text-secondaryText hover:text-primary transition-colors duration-300 text-xl"
                whileHover={{ y: -3 }}
              ...
              <motion.a
                href="https://leetcode.com/u/MuhammadIbrahim792/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-secondaryText hover:text-primary transition-colors duration-300 text-xl"
                whileHover={{ y: -3 }}
