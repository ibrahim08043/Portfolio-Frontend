      ...
      <div className="container mx-auto px-4 md:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              <p className="font-mono text-secondary">
                ...
                <br />
                &nbsp;&nbsp;name: <span className="text-accent">"Muhammad Ibrahim"</span>,
                <br />
                &nbsp;&nbsp;role: <span className="text-accent">"Front-End Developer"</span>,
                <br />
          ...
          >
            ...
            >
              I'm a passionate Front-End Developer with a strong focus on creating clean, efficient, and user-friendly web applications. With expertise in React.js, Next.js, and modern JavaScript, I build responsive interfaces that deliver exceptional user experiences.
            </motion.p>
            ...
            >
              My journey in web development began with Jawan Pakistan and was further shaped through academic and practical experiences. I combine technical skills with creative problem-solving to deliver solutions that exceed expectations.
            </motion.p>
