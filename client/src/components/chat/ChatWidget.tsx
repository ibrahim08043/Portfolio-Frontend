...
const ChatWidget = () => {
  ...
  const sendMessage = async (e?: React.FormEvent) => {
    ...
    try {
      ...
      // Call the chat API
      const response = await apiRequest<{ response: string }>("https://portfoliobackend-9tgn.onrender.com/api/chat", {
        method: "POST",
        body: JSON.stringify({
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4">
              {state.messages.length === 0 ? (
                <div className="h-full flex flex-col items-center justify-center text-center text-white/50 p-4">
                  ...
                  <p>Hi there! I'm Muhammad Ibrahim's AI assistant.</p>
                  <p className="text-xs mt-2">Ask me about Muhammad's experience, skills, education, or projects. I can tell you all about his React.js expertise, MERN stack development work at Sid Techno, or his education background.</p>
                </div>
              ) : (
